 ...
 */
public class RateNeighbourBarChart extends ApplicationFrame {

    public RateNeighbourBarChart(String applicationTitle, String chartTitle, List<RateRange> rateRanges, String status) {
